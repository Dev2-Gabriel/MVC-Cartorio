    ...
    class ConfigController extends Config {
        ...
        */
        public function __construct() {
            ...
            if (!empty(filter_input(INPUT_GET, 'url', FILTER_DEFAULT))) {
                ...
                $this->urlContoller = $this->slugController(CONTROLLER);
        ...
        */
        ...
        public function loadPage() {
            // $this->classLoad = "\\App\\adms\\Controllers\\" . $this->urlContoller;

            // $classePage = new $this->classLoad();
            // $classePage->{$this->urlMetodo}();

            $loadPgAdm = new \Core\CarregarPgAdm();
            $loadPgAdm->loadPage($this->urlContoller, $this->urlMetodo, $this->urlParam);
        }
    }
?>